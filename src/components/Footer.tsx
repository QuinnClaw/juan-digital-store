      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Digital tools designed to simplify your life. Quality templates,
              planners, and resources for creators and entrepreneurs.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-slate-400 hover:text-teal-primary transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-slate-400 hover:text-teal-primary transition-colors"
              >
        ...
        <div className="mt-10 pt-6 border-t border-slate-700 text-center">
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} Juan Digital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
